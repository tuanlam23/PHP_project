                ...
                <table id="cart" class="table table-hover table-condensed">
                    ...
                    <tbody>
                        <tr>
                            <td data-th="Product">
                                <div class="row">
                                    <div class="col-sm-2 hidden-xs"><img src="images/5.jpg" alt="..." class="img-responsive"/></div>
                                    <div class="col-sm-10">
                    ...
                    <tfoot>
                        ...
                        <tr>
                            <td>
                                ...
                                <a href="#" class="btn btn-info">Cập nhật giỏ hàng</a>  
                            </td>
                            <td colspan="2" class="hidden-xs"></td>
                            <td class="hidden-xs text-center"><strong>Tổng tiền giỏ hàng: <span>10000000</span></strong></td>
                            <td><a href="#" class="btn btn-success btn-block">Thanh toán</a></td>
                        </tr>
                    </tfoot>
                </table>
