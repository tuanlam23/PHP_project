...
if (isset($_POST['submit'])) {
    ...
    if (isset($ten)&&isset($dien_thoai)&&isset($binh_luan)) {
        $sql1="INSERT INTO blsanpham(ten,dien_thoai,binh_luan,ngay_gio,id_sp) VALUES ('$ten','$dien_thoai','$binh_luan','$ngay_gio','$id_sp')";
...
$sql2="SELECT * FROM blsanpham WHERE id_sp=$id_sp ORDER BY id_bl ASC LIMIT $perRow,$rowsPerPage";
// tong so ban ghi
...
$totalBl=mysqli_num_rows($query2);
if($totalBl>0){
?>
