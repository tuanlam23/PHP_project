...
$sql="SELECT * FROM sanpham  INNER JOIN dmsanpham WHERE sanpham.id_dm=dmsanpham.id_dm ORDER BY id_sp DESC LIMIT $perRow,$rowsPerPage";
$query=mysqli_query($conn,$sql);
// $sqlsp="SELECT * FROM sanpham ORDER BY id_dm ASC LIMIT $perRow,$rowsPerPage";
